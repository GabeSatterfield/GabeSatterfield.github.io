...
Lasergun = pygame.image.load("Assets/Character/PNG/Weapon_Color_A/Gun_02.png")
...
enemy_position = [Pr1, Pr2, Pr3, Pr4, Pr5, Pr6, Pr7, Pr8, Pr9, Pr10, Pr11, Pr12, Pr13, Pr14, Pr15, Pr16, Pr17, Pr18, Pr19, Pr20, Pr21, Pr22, Pr23, Pr24, Pr25]
...
for pos, directions in zip(enemy_position, directions_list):
    gun_traps.add(GunTrap(*pos.center, directions))
...
while True:
    ...
    while dead:
                ...
                finalscore = scorefont.render("Your final score is:   " + str(score),True,(255,255,255))
                ...
                with open("Assignment 5\leaderboard.txt",mode = "r",encoding = "utf-8" ) as f:
                    ...
                    score1 = "1. " + str(lboard[0])
                    score2 = "2. " + str(lboard[1])
                    score3 = "3. " + str(lboard[2])
                    score4 = "4. " + str(lboard[3])
                    score5 = "5. " + str(lboard[4])
                ...
                lead1_rect = lead1.get_rect(center = (640,400))
                lead2_rect = lead2.get_rect(center = (640,420))
                lead3_rect = lead3.get_rect(center = (640,440))
                lead4_rect = lead4.get_rect(center = (640,460))
                lead5_rect = lead5.get_rect(center = (640,480))
