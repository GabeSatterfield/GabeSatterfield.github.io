...
obstacle_list = [y1_rect, y2_rect, y3_rect, y4_rect, y5_rect, y6_rect, r1_rect, r2_rect, g1_rect, g2_rect, b1_rect,
                 b2_rect, h_rect]
enemy_position = [Pr1, Pr2, Pr3, Pr4, Pr5, Pr6, Pr7, Pr8, Pr9, Pr10, Pr11, Pr12, Pr13, Pr14, Pr15, Pr16, Pr17, Pr18,
                  Pr19, Pr20, Pr21, Pr22, Pr25]
    ...
    while running:
        ...
        if enemycount == 0:
            while enemycount < level:
                gun_traps.add(GunTrap(random.choice(enemy_position).center, random.choice(directions_list)))
                enemycount += 1
